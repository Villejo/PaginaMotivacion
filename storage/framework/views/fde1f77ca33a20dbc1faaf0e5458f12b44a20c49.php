...
$('.BtnRegistrarNuevoDetalleFormulario').click(function(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('Registrar_Nuevo_Detalle_Formulario')); ?>',
...
$('.BtnEliminarRegistroDetalle').click(function(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('Eliminar_Registro_Detalle_Formulario')); ?>',
		success: function(respuesta){      
			if(respuesta==0){
...
function Cargar_Tabla(){	
	...
	$.ajax({
		...
		url:'<?php echo e(url('Listar_tabla_formularios_seleccioandos')); ?>',
...
$('.BtnRegistrarNuevoFormulario').click(function(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('RegistraNuevoFormulario')); ?>',
		success: function(respuesta){      
			if(respuesta==0){ 
				Cargar_Nombres_Formularios();
