	...
	<div class="panel-heading" style="background-color: #1c6a9e">
		<h3 class="panel-title">
			...
			<div class="pull-right">
				...
				<label><font size ="3", color="#db8308" face="Tahoma"><strong><?php echo e($Asignaciones->total()); ?></strong></font></label>
			</div>
		</h3>
	</div>	
	<div class="panel-body">		
		<?php foreach($Asignaciones as $value): ?>	
			...
			<div class="panel panel-primary">
				<div class="panel-heading" style="background-color: #321a7c">		<h3 class="panel-title">
					<b>
						...
						<font size ="3", color="#16d6fc" face="Tahoma"><strong><?php echo e($value->Nombre_Equipo->nombre_equipo); ?></strong></font>
					</b>
				</h3>
			</div>
			<div class="panel-body">
								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #067bad;">
										<b>
											<strong>
												<font size ="2">
													<?php echo e($value->Nombre_Usuario->nombre_usuario); ?> <?php echo e($value->Nombre_Usuario->apellido); ?>		
												</font>
											</strong>
										</b>
									</span>
								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #067bad;">
										<b>
											<strong>
												<font size ="2">
													<?php echo e($value->Nombre_Turno->nombre_turno); ?>		
												</font>
											</strong>
										</b>
									</span>
								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #067bad;">
										<b>
											<strong>
												<font size ="2">
													<?php echo e($value->Nombre_Formulario->nombre_formulario); ?>	
												</font>
											</strong>
										</b>
									</span>
								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #067bad;">
										<b>
											<strong>
												<font size ="2">
													<?php echo e(Carbon::parse($value->fecha_inicio)->toDateString()); ?>		
												</font>
											</strong>
										</b>
									</span>
								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #067bad;">
										<b>
											<strong>
												<font size ="2">
													<?php echo e(Carbon::parse($value->fecha_fin)->toDateString()); ?>		
												</font>
											</strong>
										</b>
									</span>
				...
				<div class="panel-footer">Panel de opciones
					<div class="pull-right">
						<a href="#" data-toggle = 'modal' data-target="#Modal_Confirmacion_Delete" class="Eliminar_Asignacion" id_Eliminar_Asignacion="<?php echo e($value->id); ?>" title="Eliminar"> <strong> <font size ="3", color ="#321a7c" face="Lucida Sans"><span class= "fa fa-times fa-2x"></span></font>
						</a>
						|
						<a href="#" id="<?php echo e($value->id); ?>" id_Editar_Asignacion="<?php echo e($value->id); ?>" class="Editar_Asignacion" title="Editar" <strong> 
...
<center><?php echo e($Asignaciones->links()); ?></center>	
</div>
