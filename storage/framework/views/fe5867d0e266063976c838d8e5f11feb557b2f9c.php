...
<script type="text/javascript">
	...
	function Cargar_Tabla(){
		...
		$.ajax({
			...
			url:'<?php echo e(url('Tabla_Usuarios')); ?>',
			success: function(data){      
	...
	function Tabla_Roles_Registrados(){
		...
		$.ajax({
			...
			url:'<?php echo e(url('Tabla_Roles_Registrados')); ?>',
			success: function(data){      
	...
	$('.RegistrarRol').click(function(){
		...
		$.ajax({
			...
			url:'<?php echo e(url('RegistrarNuevoRol')); ?>',
			success: function(data){ 
				if(data==0){   
...
$('.RegistrarNuevoUsuario').click(function(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('RegistrarNuevoUsuario')); ?>',
...
$('.EditarUsuario').click(function(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('ModificarNuevoUsuario')); ?>',
		success: function(respuesta){      
			if(respuesta==0){   
...
function Cargar_Tabla_Consultada_Usuarios(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('Tabla_Usuarios_Consultada')); ?>',
		success: function(data){   
...
function Tabla_Conexion_Usuarios($id_usuario){
	...
	$.ajax({
		...
		url:'<?php echo e(url('Tabla_Conexiones_Usuarios')); ?>',
		success: function(data){      
...
$('.RestablecerPassword').click(function(){
	...
	$.ajax({
		...
		url:'<?php echo e(url('RestablecerPasswordUsuario')); ?>',
		success: function(respuesta){  
			if(respuesta==0){ 
