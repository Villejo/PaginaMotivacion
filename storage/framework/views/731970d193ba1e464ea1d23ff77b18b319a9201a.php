	...
	<div class="panel-heading" style="background-color: #562502">
		<h3 class="panel-title">
			...
			<div class="pull-right">
				...
				<label><font size ="3", color color="#000000" face="Tahoma"><strong><?php echo e($Roles->total()); ?></strong></font></label>
			</div>
		</h3>
	</div>
							...
							<tbody>		
								...
								<tr>
									<td class="highlight">
										...
										<a href="javascript:;">
											<?php echo e($numero1++); ?></a>
										</td>
										<td class="hidden-xs">
											<?php echo e(ucfirst($value->nombre_rol)); ?>

										</td>
										<td>											
											<a href="#" class="Edit_Rol" id_Rol_Edit="<?php echo e($value->id); ?>"  NombreRolEdit="<?php echo e($value->nombre_rol); ?>"   title="Eliminar Rol"><strong> 
												<font size ="3", color ="#562502" face="Lucida Sans"><span class= "fa fa-times fa-2x"></span></font>
											</a>
											|
											<a href="#" class="Edit_Rol" id_Rol_Edit="<?php echo e($value->id); ?>"  NombreRolEdit="<?php echo e($value->nombre_rol); ?>"   title="Editar Rol" <strong> 
												<font size ="3", color ="#562502" face="Lucida Sans"><span class= "fa fa-pencil-square-o fa-2x"></span></font>
											</a>
										</td>
									</tr>
									<?php endforeach; ?>	
									<center><?php echo e($Roles->links()); ?></center>
								</tbody>
							</table>
						</div>
					</div>
