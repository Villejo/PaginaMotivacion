...
<div class="page-bar col-xs-12 col-sm-12 col-md-12 col-lg-12">	
	<ul class="page-breadcrumb">
		<li>
			...
			<a href="{{ route('Equipos')}}">Administrar Equipos</a>
			<i class="fa fa-angle-right"></i>
		</li>		
		<li>
			<i class="fa fa-wrench" aria-hidden="true"></i>
			<a href="{{ route('Parametros_Equipos_R')}}">Parametros</a>
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body" id="id_panel_seleccionar_equipo" name="id_panel_seleccionar_equipo" >			
						<div class="form-group " >
							...
							<font size ="2", color ="#000000">{{Form::label("Seleccione un equipo:")}}</font>
									...
									<td>								
										<div class="form-group">				
											<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control form-filter input-sm" name="Fecha_Registro" id="Fecha_Registro"   placeholder="Fecha Inicial" value="{{Carbon::today()->toDateString()}}" readonly>
							...
							<tbody>	
								...
								<tr>
									...
									<td>								
										<div class="form-group">				
											<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control form-filter input-sm" name="fecha_registro_editar" id="Fecha_Registro_editar"   placeholder="Fecha Inicial" value="{{Carbon::today()->toDateString()}}" readonly>
												<span class="input-group-btn">
													<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
