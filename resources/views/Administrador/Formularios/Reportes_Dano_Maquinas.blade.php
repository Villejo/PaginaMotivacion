						...
						<center>							
							...
							<tr>
								...
								<td>								
									<div class="form-group">				
										<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
											<input type="text" class="form-control form-filter input-sm" name="Fecha_Inicial" id="Fecha_Inicial"   placeholder="Fecha Inicial" value="{{Carbon::today()->toDateString()}}" onchange="OcultarDatos();" readonly>
								...
								<td>								
									<div class="form-group">				
										<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
											<input type="text" class="form-control form-filter input-sm" name="Fecha_Final" id="Fecha_Final" onchange="OcultarDatos();"   placeholder="Fecha Final" value="{{Carbon::today()->toDateString()}}" readonly>
											<span class="input-group-btn">
												<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
											</span>
										</div>
...
function Consultar_Reporte(){
	...
	$.ajax({
		...
		url:'{{ url('GenerarReporteDanoMaquinas')}}',
