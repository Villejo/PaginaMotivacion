		...
		<div class="portlet-body">
			<div class="panel panel-success">
				...
				<div class="panel-body">					
					...
					<div class="col-sm-4">
						<input type="text" name="" class="form-control" value="{{$NombreEquipo}}" readonly>
					</div>				
					<div class="col-sm-2">
					...
					<div class="col-sm-4">
						<input type="text" name="" class="form-control" value="{{$Nombre_Turno}}" readonly>
					</div>
			...
			<div class="table-scrollable">
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							<td>
								{{$parametros_control=ucfirst($value->NombreParametro->nombre_parametro)}}
							</td>
							<td>
								{{$parametros_control=ucfirst($value->NombreUnidad->nombre_unidad)}}
							</td>
							<td>
